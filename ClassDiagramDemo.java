...
public void randomize() {
    System.out.println(name + ": randomize() called");
}
...
SpecialOrder(String d, String n) {
    super(d, n);
}
...
public void dispatch() {
    System.out.println("[Special] Order " + number
            + " dispatched via priority courier.");
}
...
public void dispatch() {
    System.out.println("[Normal] Order " + number
            + " dispatched via standard delivery.");
}
...
public static void main(String[] args) {
    ...
    SpecialOrder so =
            new SpecialOrder("2026-06-01", "ORD-101");

    NormalOrder no =
            new NormalOrder("2026-06-02", "ORD-102");
